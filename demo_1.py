...
if __name__ == "__main__":
    ...
    sys.add_staff("STAFF_B")
    sys.add_staff("STAFF_C")
    sys.add_staff("STAFF_D")
    ...
    sys.check_in_walkin("BRCH-00000", 2)

    # / ================================================================
    # \ show all data as tree on terminal

    print(sys.get_cafe_branches())
